...
class NeuralNetwork:
    def __init__(self, input_size, hidden_size1, hidden_size2, output_size, weight_init_std = 0.01):
        ...
        self.layers['MatrixMulti3'] = MatrixMulti(self.params['W3'], self.params['b3'])
    ...
    def gradient(self, x, t):
        ...
        grads['W3'], grads['b3'] = self.layers['MatrixMulti3'].dW, self.layers['MatrixMulti3'].db
...
network         = NeuralNetwork(input_size = 784, hidden_size1 = 204, hidden_size2 = 202, output_size = 10)
...
plt.savefig('num1b_loss_curve_train.png')
plt.show()
...
plt.savefig('num1b_loss_curve_test.png')
plt.show()
